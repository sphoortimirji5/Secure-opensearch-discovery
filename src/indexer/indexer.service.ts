...
import { Member, MembersRepository } from '../members/members.repository';
...
export class IndexerService {
    ...
    async reindexAll(batchSize = 100): Promise<ReindexResult> {
        ...
        try {
            let page = await this.membersRepository.scanPage(batchSize);
            ...
            while (page.items.length > 0) {
                ...
                page = await this.membersRepository.scanPage(batchSize, page.lastEvaluatedKey);
            }
